        ...
        if(mysqli_num_rows($d) != 0){
            while($t = mysqli_fetch_assoc($d)){
                ...
                <tr>
                    ...
                    <td>
                        <img src="../upload/student/<?php echo $t['image']?>" width="50px">
                    </td>
                    <td>
                        <a href="edit-form4.php?id=<?php echo $t['id']?>" class="btn btn-warning btn-sm"><i class="far fa-edit"></i></a>
