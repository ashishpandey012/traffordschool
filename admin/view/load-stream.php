        ...
        if(mysqli_num_rows($d) != 0){
            while($t = mysqli_fetch_assoc($d)){
                ...
                <tr>
                    ...
                    <td><?php echo ucwords($t['streamname'])?></td>
                    <td>
                        <a href="edit-stream.php?id=<?php echo $t['id']?>" class="btn btn-warning btn-sm"><i class="far fa-edit"></i></a>
