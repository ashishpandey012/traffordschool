...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        <?php
        $count = 0;
        $q = "SELECT * FROM sch_education_level ORDER BY ord ASC";
        ...
        if(mysqli_num_rows($d) != 0){
            while($t = mysqli_fetch_assoc($d)){
                ...
                <tr>
                    ...
                    <td><?php echo $t['levelname']?></td>
                    <td><?php echo $t['ord']?></td>
                    <td>
                        <a href="edit-education.php?id=<?php echo $t['id']?>" class="btn btn-warning btn-sm"><i class="far fa-edit"></i></a>
...
<script>
    $(".delete").on("click", function(){
        ...
        var tableName = 'sch_education_level';
